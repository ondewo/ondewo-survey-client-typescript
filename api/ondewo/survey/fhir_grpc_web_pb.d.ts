...
import * as ondewo_survey_fhir_pb from '../../ondewo/survey/fhir_pb'; // proto import: "ondewo/survey/fhir.proto"
...
export class FHIRClient {
  ...
  getFHIRSurveyAnswers(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.RpcError,
               response: ondewo_survey_fhir_pb.SurveyFHIRAnswersResponse) => void
