...
import * as ondewo_survey_survey_pb from '../../ondewo/survey/survey_pb'; // proto import: "ondewo/survey/survey.proto"
...
export class SurveysClient {
  ...
  createSurvey(
    ...
    callback: (err: grpcWeb.RpcError,
               response: ondewo_survey_survey_pb.Survey) => void
  ...
  listSurveys(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.RpcError,
               response: ondewo_survey_survey_pb.ListSurveysResponse) => void
  ...
  getSurveyAnswers(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.RpcError,
               response: ondewo_survey_survey_pb.SurveyAnswersResponse) => void
  ...
  createAgentSurvey(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.RpcError,
               response: ondewo_survey_survey_pb.AgentSurveyResponse) => void
